...
Cette section regroupe toutes les notes relatives à la topologie, aux protocoles et au matériel réseau.
...
??? note "Sécurité réseau"
    ...
    - [ACL - Listes de contrôle d'accès](Securite/acl.md)

??? note "Infrastructure"
    - [VLAN et Segmentation réseau](vlan.md)
    - [Routage et Routage inter-VLAN](routage.md)
    - [Spanning Tree (STP / RSTP)](spanning_tree.md)
    - [Haute Disponibilité (VIP, Cluster, HA, Stack)](haute_disponibilite.md)
    - [Câblage (RJ45, Fibre, FTTH)](cablage.md)
